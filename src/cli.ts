...
function helpText(): string {
  return [
    ...
    '         [--keep-worktree[=on-pass|always|never]] [--skip-install]',
    '         [--governance-pr]',
    '                             Run verification against the current diff.',
    '                             --governance-pr elevates protected-path findings',
    '                             out of the gating set for INTENTIONAL constitutional',
    '                             changes (version bumps, rule edits, workflow changes):',
    '                             they are printed in a separate governance section',
    '                             (JSON: `governanceFindings`) and do not affect the',
    '                             verdict; every other finding gates as usual.',
    '                             Worktree at .effective/work is preserved on failure',
    '                             by default so you can cd in and inspect; pass',
    '                             --keep-worktree=never for CI hygiene, --keep-worktree',
    '                             (or =always) to keep regardless of verdict.',
    "                             By default `prepareWorktree` runs the project's",
    '                             lockfile install (pnpm install --frozen-lockfile /',
    '                             npm ci / yarn install --immutable) so per-package',
    '                             node_modules exist for workspace projects. Pass',
    "                             --skip-install if you've populated node_modules",
    '                             some other way.',
